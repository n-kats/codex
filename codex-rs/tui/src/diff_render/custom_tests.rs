...
fn custom__差分テーマ色__色指定を全体無効化できる() {
    ...
    assert_eq!(
        style_sign_add(DiffTheme::Dark, DiffColorLevel::TrueColor),
        Style::default()
    );
    assert_eq!(
        style_del(DiffTheme::Dark, DiffColorLevel::TrueColor),
        Style::default()
    );
}
...
fn custom__差分テーマ色__色指定を部分無効化できる() {
    ...
    assert_eq!(
        style_sign_del(DiffTheme::Light, DiffColorLevel::TrueColor),
        Style::default()
    );
    assert_eq!(
        style_add(DiffTheme::Dark, DiffColorLevel::TrueColor),
        Style::default()
    );
}
