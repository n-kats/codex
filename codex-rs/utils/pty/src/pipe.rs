...
pub async fn spawn_process(
    ...
    spawn_process_with_stdin_mode(program, args, cwd, env, arg0, PipeStdinMode::Piped, None).await
}
...
pub async fn spawn_process_with_run_as(
    ...
    spawn_process_with_stdin_mode(program, args, cwd, env, arg0, PipeStdinMode::Piped, run_as).await
}
...
pub async fn spawn_process_no_stdin(
    ...
    spawn_process_with_stdin_mode(program, args, cwd, env, arg0, PipeStdinMode::Null, None).await
}
...
pub async fn spawn_process_no_stdin_with_run_as(
    ...
    spawn_process_with_stdin_mode(program, args, cwd, env, arg0, PipeStdinMode::Null, run_as).await
}
