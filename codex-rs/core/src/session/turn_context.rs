...
impl TurnContext {
    pub(crate) fn available_models(&self) -> &[ModelPreset] {
        &self.tools_config.available_models
    }

    pub(crate) fn goal_tools_enabled(&self) -> bool {
        self.goal_tools_supported && self.tools_config.goal_tools
    }

    pub(crate) fn tool_environment_mode(&self) -> ToolEnvironmentMode {
        self.tools_config.environment_mode
    }

    pub(crate) fn unified_exec_shell_mode(&self) -> UnifiedExecShellMode {
    ...
    pub(crate) fn to_turn_context_item(&self) -> TurnContextItem {
        TurnContextItem {
            ...
            workspace_roots: Some(vec![self.cwd.clone()]),
            current_date: self.current_date.clone(),
            timezone: self.timezone.clone(),
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        TurnContext {
            ...
            environment: environments.primary_environment(),
            environments,
            #[allow(deprecated)]
            cwd,
