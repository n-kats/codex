...
impl From<codex_sandboxing::SandboxType> for SandboxType {
    fn from(value: codex_sandboxing::SandboxType) -> Self {
        match value {
            codex_sandboxing::SandboxType::None => Self::None,
            codex_sandboxing::SandboxType::MacosSeatbelt => Self::MacosSeatbelt,
            codex_sandboxing::SandboxType::LinuxSeccomp => Self::LinuxSeccomp,
            codex_sandboxing::SandboxType::WindowsRestrictedToken => Self::WindowsRestrictedToken,
        }
    }
}

impl From<SandboxType> for codex_sandboxing::SandboxType {
    fn from(value: SandboxType) -> Self {
        match value {
            SandboxType::None => Self::None,
            SandboxType::MacosSeatbelt => Self::MacosSeatbelt,
            SandboxType::LinuxSeccomp => Self::LinuxSeccomp,
            SandboxType::WindowsRestrictedToken => Self::WindowsRestrictedToken,
        }
    }
}
