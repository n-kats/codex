...
mod tests {
    ...
    async fn evaluate_host_policy_emits_domain_event_for_decider_allow_override() {
        ...
        let request = NetworkPolicyRequest::new(NetworkPolicyRequestArgs {
            ...
            // Use a public IP literal to avoid relying on ambient DNS behavior; some
            // environments resolve hostnames to private IPs, which would trigger
            // `not_allowed_local` instead of `not_allowed`.
